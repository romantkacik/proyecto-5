...
export function initializeHanged() {
  ...
  // Inicializa el tablero de letras
  inicializarTableroDeLetras(selectContainer)

  // Deshabilita el tablero al iniciar el juego
  ...
  function inicializarTableroDeLetras(selectContainer) {
  ...
  function bloquearTablero(bloquear) {
    ...
    botones.forEach((boton) => {
      boton.disabled = bloquear // True para deshabilitar, false para habilitar
    })
  }
